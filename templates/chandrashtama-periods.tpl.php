    ...
    <div class="container prokerala-api-demo-container">
        ...
        <?php if (!empty($result)): ?>
            <table class="table table-bordered table-hover">
                ...
                <tr><td>Nakshatra</td><td><?= $nakshatra->getName()?></td></tr>
                ...
                <tr class="bg-secondary text-white text-center"><td>Start</td><td>End</td></tr>
                <?php foreach ($timings as $timing):?>
                    <tr><td><?= $timing->getStart()->format('Y-m-d h:i A')?></td><td><?=$timing->getEnd()->format('Y-m-d h:i:S')?></td></tr>
                <?php endforeach; ?>
            </table>
        <?php endif; ?>
            <section>
