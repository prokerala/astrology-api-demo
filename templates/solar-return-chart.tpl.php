...
<head>
    ...
    <title>Solar Return Chart | Astrology API Demo - Prokerala Astrology</title>
            ...
            <div class="row my-auto">
                <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12 text-lg-left top-header-text-content">
                    <h2 class="text-white mb-5">
                        <span class="font-weight-thin"><?= __('Solar Return Chart') ?></span>
                    </h2>
                </div>
            </div>
        </div>
    ...
    <div class="container prokerala-api-demo-container">
        ...
        <?php if (!empty($result)): ?>
            ...
            <table class="table table-bordered mt-5 mb-5">
                <tr>
                    <th><?= __('Solar Return Date') ?></th>
                    <td><?=$solarDatetime->format('d M Y, h:i A')?></td>
                </tr>
            </table>

            <h3 class="text-center"><?= __('Solar Return Planet Positions') ?></h3>
            ...
            <h3 class="text-center"><?= __('Angles') ?></h3>
            ...
            <!--            House table-->
            <h3 class="text-center mt-5"><?= __('Solar Return House Cusps') ?></h3>
            <table class="table table-bordered">
                <tr>
                    <th><?= __('House') ?></th>
                    <th><?= __('Start Cusp') ?></th>
            ...
            <!--            Aspect table-->
            <h3 class="text-center mt-5"><?= __('Solar Return Aspects') ?></h3>
            <table class="table table-bordered">
                <tr>
                    <th><?= __('Planet 1') ?></th>
                    <th><?= __('Aspect') ?></th>
            ...
            <h3 class="text-center mt-5"><?= __('Solar Return - Natal Aspects') ?></h3>
            <table class="table table-bordered">
                <tr>
                    <th><?= __('Planet 1') ?></th>
                    <th><?= __('Aspect') ?></th>
                ...
                <?php foreach($solarNatalAspects as $aspect): ?>
                    <?php if(!in_array($aspect->getAspect()->getName(), ['Opposition', 'Conjunction', 'Sextile', 'Square', 'Trine'])): ?>
                        <?php continue; ?>
                    <?php endif; ?>
                    <tr>
        ...
        <section>
            <div class="card contact-form-wrapper box-shadow mx-auto rounded-2 mb-5">
                <form class="p-5 text-default"  action="solar-return-chart.php" method="POST">
