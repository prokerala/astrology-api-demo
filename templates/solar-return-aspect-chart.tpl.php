...
<head>
    ...
    <title>Solar Return Aspect Chart | Astrology API Demo - Prokerala Astrology</title>
            ...
            <div class="row my-auto">
                <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12 text-lg-left top-header-text-content">
                    <h2 class="text-white mb-5">
                        <span class="font-weight-thin">Solar Return Aspect Chart</span>
                    </h2>
                </div>
            </div>
        </div>
    ...
    <div class="container prokerala-api-demo-container">
        ...
        <?php if (!empty($result)): ?>
            ...
            <div id="chart" class="item-block align-center tc">
                <div class="solar-return-aspect-chart-wrapper item-block">
        ...
        <section>
            <div class="card contact-form-wrapper box-shadow mx-auto rounded-2 mb-5">
                <form class="p-5 text-default"  action="solar-return-aspect-chart.php" method="POST">
