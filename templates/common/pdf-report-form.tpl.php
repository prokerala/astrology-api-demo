...
<div class="form-group row">
    <label class="col-sm-3 col-md-4 col-form-label  text-md-right text-xs-left ">Hide Ashtakavarga:</label>
    <div class="col-sm-9 col-md-6 ">
        <select name="hide_ashtakavarga" class="form-control form-control-lg rounded-1">
