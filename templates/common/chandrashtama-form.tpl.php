...
<div class="form-group row">
    ...
    <div class="col-sm-9 col-md-6 ">
        <input type='text' id="fin-year" name="year" autocomplete="off" class="form-control form-control-lg rounded-1" placeholder="Enter the years in int (eg: 2022)" value="" required>
    </div>
</div>
