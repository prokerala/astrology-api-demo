<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8 pl-md-0">
                <input type='datetime-local' name="girl_dob" class="form-control form-control-lg rounded-1" placeholder="DD-MM-YYYY" required="required" value="<?=$girl_dob->format('Y-m-d\Th:i')?>"/>
            </div>
        </div>
    ...
    <div class="col-12 col-md-6">
        ...
        <div class="form-group row">
            <label class="col-md-4 pr-md-0 col-form-label">Date Of Birth:</label>
            <div class="col-md-8 pl-md-0">
                <input type='datetime-local' name="boy_dob" class="form-control form-control-lg rounded-1" placeholder="DD-MM-YYYY" required="required" value="<?=$boy_dob->format('Y-m-d\Th:i')?>"/>
            </div>
        </div>
