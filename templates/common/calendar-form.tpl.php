<div class="form-group row">
    ...
    <div class="col-sm-9 col-md-6 ">
        <input type='date' name="date" class="form-control form-control-lg rounded-1" required="required" value="<?= $date->format('Y-m-d')?>" min="<?=$dateMinimum->format('Y-m-d')?>" max="<?=$dateMaximum->format('Y-m-d')?>"/>
    </div>
</div>
<div class="form-group row">
